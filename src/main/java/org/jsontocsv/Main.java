...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
       /* *//*
         ...
         */
        List<Map<String, String>>  flatJson = JSONFlattener.parseJson(new File("files/gro/400100015.json"), "UTF-8");
        // Using ';' as separator
        CSVWriter.writeToFile(CSVWriter.getCSV(flatJson, ";"), "files/gro/400100015_new.csv");
